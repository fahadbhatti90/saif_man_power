                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Add Job</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="form-row needs-validation" method="POST" action="{{ route('store-job') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <input type="hidden" name="countries_route" value="{{ route('get-countries') }}">
                                        <input type="hidden" class="job_post_type" id="job_post_type" name="job_post_type" value="1">
                                          ...
                                          <div class="form-group col-md-6 col-sm-11 select-border">
                                            <label>Job Category *</label>
                                            <select class="form-control basic-select" class="job_sector" name="job_sector" required>
                                                <option value="{{ old('$row->title') }}">Select</option>
                                          ...
                                          {{--<div class="form-group col-md-1 col-sm-1 select-border my-auto pt-2">
                                            <a href="javascript:void(0)" title="Add Job Category" class="btn btn-success btn-round btn-sm custom-add-dropdown-sweet-alert" data-input-name="title" data-input-positions="positions" data-title="Add Job Category" data-action="add-job-category-ajax" data-module="Job Category" data-pos-module="Positions"><i class="fa fa-plus"></i></a>
                                          </div>--}}
...
{{--                                          <div class="form-group col-md-12 mb-0">
                                          ...
                                          <div class="form-group col-md-6 select-border" class="salary">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Country *</label>
                                            <input type="text" class="form-control" name="country_name" value="{{ old('country_name') }}" placeholder="Enter Country Name" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>City *</label>
                                            <input type="text" class="form-control" name="city_name" value="{{ old('city_name') }}" placeholder="Enter City Name" required>
