                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide" action="{{ route('store-client') }}" method="POST" enctype="multipart/form-data">
                                    	@csrf
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label" for="title">Country
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-8">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label" for="image">Image <span
                                                            class="text-danger">*</span><span><small class="text-danger"> (1920 x 700)</small></span>
                                                    </label>
                                                    <div class="col-lg-8">
